...
/**
 * Supertypes are categories that apply across card types and drive special
 * rules:
 *  - token: generated by effects, NOT part of any deck (e.g. Recruit).
 *  - champion: a unit tied to a Legend; deckbuilding limits apply.
 *  - signature: a signature card; deckbuilding limits apply.
 *  - basic: a basic resource (basic Runes).
 */
export type Supertype = 'token' | 'champion' | 'signature' | 'basic'
...
export interface CardBase {
  ...
  name: string
  type: CardType
  /** Supertype, when the card has one (token / champion / signature / basic). */
  supertype?: Supertype
